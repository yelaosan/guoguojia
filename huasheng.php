...
<form name="aspnetForm" method="post" action="login.php?id=<?php echo $list_id?>" id="aspnetForm">
  <div class="container">
        <h3>原味炒花生</h3>
        <p><img src="http://1.testbeta.sinaapp.com/images/huasheng.jpg" ></p>
        <em><center>订购<?php echo $num_buy?>件&nbsp;&nbsp;&nbsp;浏览<?php echo $num_visit?>次</center></em>
	<p>商品描述：</p>
	<ul>
		<li>
		原产地：山东</br>
		商品描述：原味炒制，颗粒饱满，来自山东。</br>
		注意事项：无。</br>
		营养价值：降低胆固醇：花生油中含有的亚油酸，可使人体内胆固醇分解为胆汁酸排出体外，避免胆固醇在体内沉积，减少因胆固醇在人体中超过正常值而引发多种心脑血管疾病的发生率。
		</li>
	</ul>  
	<p>价格：<span>￥7.50/斤</span></br>
		   数量：
